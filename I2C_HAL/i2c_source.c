...
static void startTransactionI2C(I2C_DEF  i2cIn, uint8_t address_dev, uint8_t address_reg, uint16_t num_read, uint8_t *buff, I2C_TRANSACTION_TYPE typeTransaction);
...
static void startTransactionI2C(I2C_DEF  i2cIn, uint8_t address_dev, uint8_t address_reg,
		                          uint16_t num_read, uint8_t *buff, I2C_TRANSACTION_TYPE typeTransaction){
...
I2C_STATUS i2cConfig( I2C_DEF i2cIn ,I2C_configDef *config){
	...
	i2cInitGpio(0);
	I2CProcessing[i2cIn].frq = config->frequencyI2C;
...
I2C_STATUS i2cTxData(I2C_DEF i2cIn, uint8_t address_dev, uint8_t address_reg, uint16_t num_read, uint8_t *buff){
...
I2C_STATUS i2cRxData(I2C_DEF i2cIn, uint8_t address_dev, uint8_t address_reg, uint16_t num_read, uint8_t *buff){
	uint32_t maxTimeTransaction = getTimeTransaction(i2cIn, num_read);
