...
I2C_STATUS i2cTxData(I2C_DEF i2c, uint8_t address_dev, uint8_t address_reg, uint16_t num_read, uint8_t *buff);
I2C_STATUS i2cRxData(I2C_DEF i2c, uint8_t address_dev, uint8_t address_reg, uint16_t num_read, uint8_t *buff);
